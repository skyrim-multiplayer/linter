...
var require_common = __commonJS({
  "node_modules/@kwsites/file-exists/node_modules/debug/src/common.js"(exports, module) {
    function setup(env) {
...
var require_browser = __commonJS({
  "node_modules/@kwsites/file-exists/node_modules/debug/src/browser.js"(exports, module) {
...
var require_node = __commonJS({
  "node_modules/@kwsites/file-exists/node_modules/debug/src/node.js"(exports, module) {
...
var require_src = __commonJS({
  "node_modules/@kwsites/file-exists/node_modules/debug/src/index.js"(exports, module) {
...
var require_common2 = __commonJS({
  "node_modules/simple-git/node_modules/debug/src/common.js"(exports, module) {
    function setup(env) {
      createDebug.debug = createDebug;
      createDebug.default = createDebug;
      createDebug.coerce = coerce2;
...
var require_browser2 = __commonJS({
  "node_modules/simple-git/node_modules/debug/src/browser.js"(exports, module) {
    exports.formatArgs = formatArgs;
    exports.save = save;
    exports.load = load;
    exports.useColors = useColors;
...
var require_node2 = __commonJS({
  "node_modules/simple-git/node_modules/debug/src/node.js"(exports, module) {
    var tty = __require("tty");
    var util = __require("util");
    exports.init = init;
    exports.log = log;
...
var require_src3 = __commonJS({
  "node_modules/simple-git/node_modules/debug/src/index.js"(exports, module) {
    if (typeof process === "undefined" || process.type === "renderer" || process.browser === true || process.__nwjs) {
...
var TscCheck = class extends BaseCheck {
  ...
  async resolveDeps({ shouldSearchInPath }) {
    ...
    if (!tscPath) {
      const localBin = path11.resolve(this.repoRoot, "node_modules", ".bin", "tsc");
      try {
  ...
  #runTsc(deps) {
    if (!this.#resultPromise) {
      this.#resultPromise = (async () => {
        ...
        const args = ["--noEmit", "--pretty", "false", "-p", path11.resolve(this.repoRoot, this.#tsconfigPath)];
        try {
          ...
          for (const line of output.split("\n")) {
            ...
            if (match) {
              const absFile = path11.resolve(this.repoRoot, match[1]);
...
var AllFilesSource = class extends BaseFileSource {
  ...
  async resolve() {
    ...
    const files = output.split("\n").filter((f) => f.trim() !== "").filter((rel) => {
      ...
      return true;
    }).map((f) => path12.resolve(this.repoRoot, f));
...
var loadConfig = async (mode) => {
  ...
  const config = JSON.parse(await fs17.promises.readFile(configPath, "utf-8"));
...
`;
  if (fs17.existsSync(hookPath)) {
    ...
    fs17.copyFileSync(hookPath, backup);
...
var upgrade = () => {
  ...
  switch (method) {
    ...
    case "single-file": {
      ...
      const head = fs17.readFileSync(tmpPath, "utf-8").slice(0, 100);
      if (!head.startsWith("#!/")) {
        fs17.unlinkSync(tmpPath);
        console.error("Downloaded file does not look like a valid linter bundle. Aborting.");
        process.exit(1);
      }
      fs17.renameSync(tmpPath, __filename);
      fs17.chmodSync(__filename, 493);
...
(async () => {
  ...
  try {
    ...
    let files;
    if (filesArg !== null) {
      files = filesArg.map((f) => path15.isAbsolute(f) ? f : path15.resolve(REPO_ROOT, f));
    } else {
    ...
    if (outputPrdPath !== null) {
      const relScript = path15.relative(REPO_ROOT, process.argv[1]);
      ...
      fs17.writeFileSync(absOutputPrdPath, JSON.stringify(prd, null, 2) + "\n");
